  ...
  return (
    <Card className="border-0 overflow-hidden">
      <div className="bg-gradient-to-br from-indigo-500 to-purple-600 p-4 text-white">
        ...
        <h2 className="heading-lg text-center">¡Todo Listo!</h2>
        <p className="caption text-indigo-100 text-center mt-1">Tu mentor está preparado para ayudarte a aprender</p>
      </div>
        ...
        <div className="space-y-4 mb-6">
            ...
            <div className="bg-gradient-to-r from-indigo-50 to-purple-50 p-3 rounded-lg border border-indigo-100 shadow-inner">
              <div className="flex items-center">
                ...
                <div className="ml-3 text-left">
                  <h3 className="heading-xs text-gray-800">{mentorName}</h3>
                  <p className="caption text-gray-600">Tu Mentor {selectedAvatar.name}</p>
                </div>
              </div>
              <div className="mt-2 bg-white/70 backdrop-blur-sm rounded-lg p-2 caption text-gray-600">
          ...
          <div className="grid grid-cols-3 gap-2 mt-4">
            <div className="bg-indigo-50 p-3 rounded-lg text-center">
              ...
              <span className="caption text-gray-700">Notas de Estudio</span>
            </div>
            <div className="bg-indigo-50 p-3 rounded-lg text-center">
              <CalendarIcon className="w-5 h-5 mx-auto mb-1 text-indigo-500" />
              <span className="caption text-gray-700">Cuestionarios</span>
            </div>
            <div className="bg-indigo-50 p-3 rounded-lg text-center">
              <MessageCircleIcon className="w-5 h-5 mx-auto mb-1 text-indigo-500" />
              <span className="caption text-gray-700">Chat</span>
            </div>
          </div>
        </div>
